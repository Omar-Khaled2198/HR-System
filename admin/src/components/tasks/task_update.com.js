		...
		return (
			<div>
				<section className="content-header">
					<h1>Update Task: {!this.state.is_loading&&this.state.task.title}</h1>
				</section>
				{
						...
						<div className="box-body">
							<div style={{ display: "flex" }}>
								<div className="customDatePickerWidth form-group">
									...
									<DatePicker
										selected={Date.parse(this.state.task.start_at)}
										onChange={date =>
								...
								<div className="customDatePickerWidth form-group">
									...
									<DatePicker
										selected={Date.parse(this.state.task.deadline)}
										onChange={date =>
											this.setState(prevState=>({
												task: {
													...prevState.task,
							...
							<div className="customDatePickerWidth form-group">
									...
									<DatePicker
                                        selected={Date.parse(this.state.task.done)}
                                        className={"form-control"}
										onChange={date =>
											this.setState(prevState=>({
												task: {
										...
										timeCaption="time"
                                        dateFormat="Pp"
                                        disabled={this.state.task.status=="Done"?false:true}
									/>
								</div>
						</div>
