        ...
        <div>
            <header className="main-header">
                ...
                <a href="index2.html" className="logo">
                  ...
                  <span className="logo-lg"><b>HR</b>System</span>
                </a>
                          ...
                          <li>
                            ...
                            <ul className="menu">
                              ...
                              <li>
                                <a href="#">
                                  <div className="pull-left">
                                    <img src="assets/dist/img/user3-128x128.jpg" className="img-circle" alt="User Image" />
                                  </div>
                                  <h4>
                              ...
                              <li>
                                <a href="#">
                                  <div className="pull-left">
                                    <img src="assets/dist/img/user4-128x128.jpg" className="img-circle" alt="User Image" />
                                  </div>
                                  <h4>
                                    Developers
